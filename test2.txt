...
public class TextFile extends ArrayList<String> {
    ...
    public TextFile(String fileName, String splitter) {
        ...
        if(get(0).equals("")) {
            System.out.println("get(0).equals(\"\")");
            remove(0);
        }
    }
...
//        String file = read("TextFile.java");
        String file = read("/Users/didi/IdeaProjects/MyThinkInJava/src/net/mindview/util/TextFile.java");
        write("test.txt", file);
        TextFile text = new TextFile("test.txt");
        text.write("test2.txt");
        // Break into unique sorted list of words:
        TreeSet<String> words = new TreeSet<String>(
                new TextFile("/Users/didi/IdeaProjects/MyThinkInJava/src/net/mindview/util/TextFile.java", "\\W+"));
